...
export default function NewsPage() {
  ...
  const baseFilteredFeed = useMemo(() => {
    ...
    // Keep only tracked-company/core-industry items and drop obvious false positives.
    ...
    return dedupeBySimilarTitle(feed);
  ...
  const topNewsFeed = useMemo(() => {
    ...
    const cleaned = filteredFeed.filter(isTopNewsEligible);
